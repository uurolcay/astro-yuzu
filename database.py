...
class SourceDocument(Base):
    ...
    processing_cursor_page = Column(Integer, nullable=False, default=0)
...
def _add_missing_columns():
    ...
    with engine.begin() as connection:
        ...
        add_col("source_documents", "processing_status", "VARCHAR DEFAULT 'uploaded' NOT NULL")
        add_col("source_documents", "processing_cursor_page", "INTEGER DEFAULT 0 NOT NULL")
        add_col("source_documents", "page_count", "INTEGER")
